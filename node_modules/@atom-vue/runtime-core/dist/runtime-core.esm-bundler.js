import { pauseTracking, resetTracking, isRef, toRaw, isProxy, shallowReactive, effect, stop, isReactive, reactive, shallowReadonly, computed as computed$1, ref } from '@atom-vue/reactivity';
export { customRef, isProxy, isReactive, isReadonly, isRef, markRaw, reactive, readonly, ref, shallowReactive, shallowReadonly, shallowRef, toRaw, toRef, toRefs, triggerRef, unref } from '@atom-vue/reactivity';
import { isString, isFunction, isPromise, isArray, isOn, camelize, capitalize, isObject, EMPTY_ARR, extend, normalizeClass, normalizeStyle, EMPTY_OBJ, hyphenate, def, hasOwn, isReservedProp, toRawType, makeMap, NO, invokeArrayFns, NOOP, remove, hasChanged, isGloballyWhitelisted, toDisplayString } from '@atom-vue/shared';
...
function baseCreateRenderer(options, createHydrationFns) {
    ...
    const processFragment = (n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, optimized) => {
        // wangyan51: 由createText改为createComment，vue中anchor全部都改为comment节点
