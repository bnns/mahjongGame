import { ComputedGetter } from '@atom-vue/reactivity';
import { ComputedRef } from '@atom-vue/reactivity';
import { customRef } from '@atom-vue/reactivity';
import { DebuggerEvent } from '@atom-vue/reactivity';
import { isProxy } from '@atom-vue/reactivity';
import { isReactive } from '@atom-vue/reactivity';
import { isReadonly } from '@atom-vue/reactivity';
import { isRef } from '@atom-vue/reactivity';
import { markRaw } from '@atom-vue/reactivity';
import { reactive } from '@atom-vue/reactivity';
import { ReactiveEffect } from '@atom-vue/reactivity';
import { ReactiveEffectOptions } from '@atom-vue/reactivity';
import { readonly } from '@atom-vue/reactivity';
import { Ref } from '@atom-vue/reactivity';
import { ref } from '@atom-vue/reactivity';
import { shallowReactive } from '@atom-vue/reactivity';
import { shallowReadonly } from '@atom-vue/reactivity';
import { shallowRef } from '@atom-vue/reactivity';
import { toRaw } from '@atom-vue/reactivity';
import { toRef } from '@atom-vue/reactivity';
import { ToRefs } from '@atom-vue/reactivity';
import { toRefs } from '@atom-vue/reactivity';
import { TrackOpTypes } from '@atom-vue/reactivity';
import { TriggerOpTypes } from '@atom-vue/reactivity';
import { triggerRef } from '@atom-vue/reactivity';
import { unref } from '@atom-vue/reactivity';
import { UnwrapRef } from '@atom-vue/reactivity';
import { WritableComputedOptions } from '@atom-vue/reactivity';
import { WritableComputedRef } from '@atom-vue/reactivity';
 ...
 * @example
 * ```ts
 * declare module '@atom-vue/runtime-core' {
...
declare module '@atom-vue/reactivity' {
