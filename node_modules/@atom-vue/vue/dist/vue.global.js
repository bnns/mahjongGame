var Vue = (function (exports) {
  ...
  const ELEMENT_TAGS = 'stack,decorated-box,text,container,positioned-box,flex,row,column,padding,page-view';
  ...
  */
  ...
  const createApp = ((...args) => {
      ...
      app.mount = (containerOrSelector) => {
          ...
          // wangyan51：
          // todo: mount之前应该清理掉container中所有的children
  ...
  function injectNativeTagCheck(app) {
      ...
      Object.defineProperty(app.config, 'isNativeTag', {
          // wangyan51: 去掉isSVGTag、isHTMLTag，改用isElementTag
          value: (tag) => isElementTag(tag),
          writable: false
      });
  }
  // wangyan51：container改为只支持接收Element
