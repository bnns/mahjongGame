import { registerRuntimeHelpers, isBuiltInType, createSimpleExpression, createCompilerError, createObjectProperty, transformModel as transformModel$1, findProp, hasDynamicKeyVBind, transformOn as transformOn$1, createCompoundExpression, createCallExpression, createObjectExpression, noopDirectiveTransform, baseCompile, baseParse } from '@atom-vue/compiler-core';
export * from '@atom-vue/compiler-core';
import { isVoidTag, isElementTag, makeMap } from '@atom-vue/shared';
...
const parserOptions = {
    isVoidTag,
    // wangyan51: 去掉isSVGTag、isHTMLTag，改用isElementTag
    isNativeTag: tag => isElementTag(tag),
